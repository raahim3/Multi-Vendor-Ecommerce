    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#categories" class="nav-link collapsed"
                        aria-controls="pagesExamples" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="fa fa-user text-secondary text-sm opacity-10"></i>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#sub_categories" class="nav-link collapsed"
                        aria-controls="pagesExamples" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="fa fa-user text-secondary text-sm opacity-10"></i>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#blogs" class="nav-link collapsed"
                        aria-controls="pagesExamples" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="fa fa-user text-secondary text-sm opacity-10"></i>
                    ...
                    <div class="collapse {{ Request::is('admin/blogs') ? 'show' : '' }} {{ Request::is('admin/blogs/*') ? 'show' : '' }}" id="blogs" style="">
                        <ul class="nav ms-4">
                            <li class="nav-item {{ Request::is('admin/blogs') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.blogs.index') }}" wire:navigate>
                                    <span class="sidenav-mini-icon"> P </span>
