...
@section('title', 'Create Blog Sub Categories')
        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
              <p class="mb-0">Create Blog Sub Category</p>
            </div>
          </div>
          <div class="card-body">

            <form action="{{ route('admin.blog.sub_categories.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex">
                            ...
                            &nbsp;
                            <div class="col-md-2">
                                <button class="btn btn-primary btn-sm" type="button" id="add_blog_sub_category"> <i class="fa fa-plus"></i> Add</button>
                            </div>
                        </div>
                        @error('title')
                            <span class="validated_txt">{{ $message }}</span>
